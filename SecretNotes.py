...
title_info_label = Label(text="Enter your title",font=("Arial",20,"normal"))
title_info_label.pack()

title_entry = Entry(width=30)
title_entry.pack()

input_info_label = Label(text="Enter your secret",font=("Arial",20,"normal"))
input_info_label.pack()

input_text = Text(width=30, height=10)
input_text.pack()

master_secret_label = Label(text="Enter master key",font=("Arial",20,"normal"))
